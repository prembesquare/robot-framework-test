...
${disabled_lower}       //button[@class="btn-purchase btn-purchase--disabled btn-purchase--2"]
...
choose amount
    ...
    Click Element    ${payoutAmt}
    Input Text    ${payoutAmt}    10
    Wait Until Element Is Visible    ${disabled_lower}    10
    Page Should Contain Element    ${disabled_lower}
